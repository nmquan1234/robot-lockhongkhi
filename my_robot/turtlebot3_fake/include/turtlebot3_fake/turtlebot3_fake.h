...
class Turtlebot3Fake
{
 ...
 private:
  ...
  ros::Subscriber cmd_vel_left_sub_;
  ros::Subscriber cmd_vel_right_sub_;
  ...
  // Function prototypes
  void commandRightVelocityCallback(const std_msgs::Float32::ConstPtr& cmd_vel_msg);
  void commandLeftVelocityCallback(const std_msgs::Float32::ConstPtr& cmd_vel_msg);
